...
<div class="case-study-body">
  ...
  <p>Because the scope of the site is small, it's a good opportunity to develop my workflow and learn new tricks. The big thing I wanted to try with this design was a modular scale for the typography. The site is fairly type-heavy as is, so it seems sensible to follow some rules. Besides that, I've grown increasingly frustrated working with web typography, especially in a responsive context, so it was about time to find a process.</p>
...
h1 {
  ...
  <p>I'm a fan of front-end frameworks, but I can certainly acknowledge that your tools should suit the project. With that in mind, I had a suspicion I would want to use a smaller grid framwork. When it comes to small projects, I tend to only want the grid and typography of a framework; the more complex UI elements (dropdowns, form controls) I don't need, and the less complex elements (buttons) I can build myself.</p>

  <p>This seemed like a good opportunity to learn a new framework and expand my literacy in the space. For the most part I've only used <a href="http://foundation.zurb.com">Foundation</a> and <a href="http://neat.bourbon.io">Bourbon Neat</a> for projects. I think these are both great tools, but they both have things that annoy me. So I looked into other frameworks I had heard of but never used. <a href="http://www.getskeleton.com/">Skeleton</a>? Oh, it's CSS-only. Not into that. <a href="http://semantic.gs/">Semantic.gs</a>? Not really a fully-featured grid from what I can tell.</p>

  <p>Eventually I landed on <a href="http://susy.oddbird.net/">Susy</a>, which from what I can tell is probably the most versatile and also most complex grid framework out there. It supports all of the fun stuff I want in a grid system, like offsets, source ordering, and centering. Like most frameworks you can define breakpoints to change how your grid columns look at different screen sizes, but Susy also allows you to change the properties of the grid itself. For example, you can have a 4-column grid by default, a 12-column grid above 768px, and a 17-column grid above 961px. You can define new grid styles within other columns, with their own separate column count. It's crazy! I had no use for these advanced features but I'm glad they exist.</p>

  <p>Since this is just a basic mostly-static site, I'm just using PHP. However, I knew I wanted to tap into a few external libraries, so I went about looking for a PHP package manager. I have no idea what the space looks like, or what "standards" exist, but I ended up using <a href="http://getcomposer.org">Compsoer</a>, which happened to have the two packages I needed.</p>

  <p>The source code of this site is available on <a href="http://github.com/gakimball/portfolio">GitHub</a> if you're interested in seeing how I write markup and styling, or the kinds of tools I use. I somehow ended up with at least three sets of dependencies for my development environment, but I suppose that's fine because I'm the only person who will ever do serious work on it anyway. The site makes several API calls, and I have those keys hidden away in an environment file. This is a trick <a href="">Heroku</a> uses for its apps: sensitive information is tucked away in a file not checked into version control, and loaded into the environment at runtime. Someone made a library to do this in php called <a href="">phpdotenv</a>, which I make use of.</p>
