...
<div class="case-study-body">
  ...
  <p>This became the monumental challenge with this project: here are 39 various project pages which span 4 years of changing design languages. On top of that, none of them are responsive (a key tenet of ZURB's design today) and the site runs on an old grid system that predates even the first Foundation (Foundation is now on version 5).</p>
